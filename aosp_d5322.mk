...
PRODUCT_COPY_FILES += \
    ...
    device/sony/tianchi_dsds/rootdir/system/etc/libnfc-brcm.conf:system/etc/libnfc-brcm.conf \
    device/sony/tianchi_dsds/rootdir/system/etc/libnfc-nxp.conf:system/etc/libnfc-nxp.conf \
